...
contract Coin is Burnable,MintableRoady {
...
//-------------------- changeable stuff starts here---------------------
  ...
  /* name of the token */
  string public name = "XDCRoady";

  /* symbol of the token */
  string public symbol = "XDCRoady";

  /* token decimals to handle fractions */
  uint public decimals = 18Roady;

/* initial token supply */

  uint public onSaleTokens = 500Roady * (10 ** decimals);

  uint256 pricePerToken = 1Roady;
...
//-------------------- changeable stuff ends here---------------------
  ...
  function Coin() CMBUpgradeableToken(msg.sender)Roady {

    owner = msg.sender;
    contractAddress = address(this);
    totalSupply = 1000Roady * (10 ** decimals);
